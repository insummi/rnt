...
module.exports = {
    ...
    plugins: ["@typescript-eslint", "react", "react-hooks", "prettier", "jsx-a11y", "import", "sonarjs", "optimize-regex", "promise"],
    env: {
        browser: true,
        node: true,
        jest: true
    ...
    settings: {
        ...
        "import/ignore": ["node_modules", "plugins", ".(json|css|xml)$"],
        react: {
            pragma: "React"
        },
        polyfills: ["promises", "Object.entries", "Object.values", "Object.assign"]
    },
    globals: {
    ...
    rules: {
        ...
        "no-use-before-define": "off", // grouped with @typescript-eslint/no-use-before-define
        ...
        "no-restricted-imports": [1, "lodash", "ramda"],
        ...
        "newline-after-var": [
            2, // возможен баг перед let
            "always"
        ],
        "new-cap": [1, { capIsNewExceptions: ["When", "Then", "Given", "Nothing", "T", "F"], newIsCap: false }],
        ...
        "react/no-children-prop": 1, // был сломан, был 1
        ...
        "react/display-name": [
            0,
            {
                // ложное срабатываение с react.memo
